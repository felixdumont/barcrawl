...
price_range_options = [
    ...
    for price_range in ['Small', 'Medium', 'Large']]
...
app.layout = html.Div(
    [
        ...
        html.Div([
                    ...
                    [
                        html.Div(
                            [
                                html.Div([
                                    html.Img(
                                        src=app.get_asset_url("amazon_logo.png"),
                                        id="yelp-image",
                                        style={
                                            "height": "120px",
                                            "width": "auto",
                            ...
                            [
                                html.Div(
                                    [
                                        html.Div([
                                            html.H1(
                                                "Amazon Fresh Delivery Scheduler",
                    ...
                    [
                        html.Div(
                            [html.Div([
                                ...
                                html.Div([
                                    html.Div([
                                        html.Label("Max total driving time"),
                                        html.Div(dcc.Input(
                                            id="max_walking_time",
                                            type='text',
                                            value=30,
                                    ...
                                    html.Div([
                                        html.Label("Max driving time between each customer"),
                                        html.Div(dcc.Input(
                                ...
                                html.Div([
                                    html.Div([
                                        html.Label("Total number of packages"),
                                        html.Div(dcc.Input(
                                            id="min_review_ct",
                                            type='text',
                                            value=20,
                                    ...
                                    html.Div([
                                        html.Label("Packages containing dairy products"),
                                        html.Div(dcc.Input(
                                            id="min_review",
                                            type='text',
                                            value=3.0,
            ...
            ], className="four columns instruction", style={"background-color": "#232f3e"}
            ),
                ...
                [
                    ...
                    dcc.Tabs(
                        ...
                        children=[
                            ...
                            dcc.Tab(label="VALIDATE CAPACITY", value="tab-two"),
                            dcc.Tab(label="VIEW ROUTE", value="tab-three"),
                        ],
                        className="tabs",
                    ),
                    html.Div(
            ...
            className="row twelve columns", style={"background-color": "#eaeded"} )
    ],
    id="mainContainer",
...
def fill_tab(tab):
    ...
    return [
        ...
        html.Label(
            "."),
        html.Img(
            src=app.get_asset_url("amazon_giphy3.gif"),
            id="mit-image",
            style={
                "height": "400px",
                "width": "auto",
